...
//						}
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DTO dto = new DTO(FloorChoice.carIn.getCar_num(), position, FloorChoice.carIn.getOut_time());
				dao.insert_member(dto);
				FloorChoice floorChoice = new FloorChoice();
				floorChoice.main(null);
